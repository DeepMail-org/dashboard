...
export const CreditUsageCard: React.FC<CreditUsageCardProps> = ({
  ...
  return (
    <div className={wrapperClassName ?? "flex w-full flex-col items-center justify-center bg-transparent p-4 font-sans transition-colors duration-500 sm:p-8 md:p-12"}>
