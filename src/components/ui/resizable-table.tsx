            ...
            <AnimatePresence mode="wait">
              ...
              >
                {paginatedEmployees.map((employee) => (
                  <motion.div key={employee.id} variants={shouldAnimate ? rowVariants as unknown as import("framer-motion").Variants : undefined}>
                    <div
