...
const TimeSeriesChartCore = memo(function TimeSeriesChartCore({
  ...
  const rawProjectionConfigs = extractProjectionLineConfigs(children);
  const projectionConfigsJSON = JSON.stringify(rawProjectionConfigs);
  // eslint-disable-next-line react-hooks/exhaustive-deps
  const projectionConfigs = useMemo(() => rawProjectionConfigs, [projectionConfigsJSON]);
