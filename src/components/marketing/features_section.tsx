...
const GlobePulse = dynamic(
	() =>
		import("@/components/marketing/ui/cobe-globe-pulse").then(
			(m) => m.GlobePulse,
		),
	...
	return (
		<div className="relative z-20 mx-auto max-w-7xl py-10 lg:py-32">
			...
			<div className="relative">
				<div className="mt-12 grid grid-cols-1 rounded-2xl lg:grid-cols-6 xl:border border-white/6 bg-white/1.5 shadow-[0_16px_64px_rgba(0,0,0,0.6),0_4px_16px_rgba(0,0,0,0.4)]">
...
const SkeletonOne = () => {
	const files = [
		{ name: "phish-bd4f2a1.eml", score: 94 },
		{ name: "wire-transfer-req.eml", score: 81 },
		{ name: "invoice_march_2024.eml", score: 67 },
		{ name: "hr-policy-update.eml", score: 23 },
	];
	return (
								...
								<div className="mt-1 flex items-center gap-2">
									<div className="h-1 flex-1 overflow-hidden rounded-full bg-white/4">
										<motion.div
											...
											viewport={{ once: true }}
											className={`h-full ${score >= 80 ? "bg-linear-to-r from-red-400/70 to-rose-400/60" : score >= 50 ? "bg-linear-to-r from-amber-400/60 to-yellow-400/60" : "bg-linear-to-r from-emerald-400/60 to-cyan-400/60"}`}
										/>
									</div>
