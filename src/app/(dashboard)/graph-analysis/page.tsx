...
const INVESTIGATION_NODES: WorkflowNode[] = [
    {
        ...
        description:
            "New phishing email detected by ML model with 98.2% confidence",
        icon: AlertTriangle,
        color: "red",
        position: { x: 50, y: 120 },
    },
    {
        ...
        title: "Extract IOCs",
        description:
            "Parse URLs, IPs, domains, and file hashes from email body & attachments",
        icon: Search,
        color: "blue",
        position: { x: 300, y: 60 },
    },
    {
        ...
        description:
            "Validate SPF/DKIM/DMARC, trace mail relay path, check X-headers",
        icon: Mail,
        color: "purple",
    ...
    },
    {
        ...
        description:
            "Detonate attachments in isolated sandbox, analyze runtime behavior",
        icon: Shield,
        color: "amber",
        position: { x: 550, y: 60 },
    },
    {
        ...
        description:
            "Cross-reference IOCs against VirusTotal, AbuseIPDB, MISP feeds",
        icon: Globe,
        color: "cyan",
    ...
    },
    {
        ...
        title: "MITRE Mapping",
        description:
            "Map TTPs to MITRE ATT&CK framework — T1566.001 Spearphishing",
        icon: Key,
        color: "orange",
    ...
    },
    {
        ...
        title: "Create Case",
        description:
            "Generate incident report, assign to SOC analyst, set SLA timer",
        icon: FileCode,
        color: "green",
...
const LATERAL_NODES: WorkflowNode[] = [
    {
        ...
        description:
            "Excessive RDP login attempts from internal host SE-KTH-RDP",
        icon: AlertTriangle,
        color: "red",
        position: { x: 50, y: 150 },
    },
    {
        ...
        description:
            "Correlate failed logins with successful auth events across domain controllers",
        icon: Key,
        color: "purple",
        position: { x: 300, y: 80 },
    },
    {
        ...
        description:
            "Analyze NetFlow data for unusual port usage, SMB/WMI lateral traffic",
        icon: Network,
        color: "cyan",
    ...
    },
    {
        ...
        description:
            "ML-based anomaly detection score: 94/100 — high-confidence threat",
        icon: Shield,
        color: "amber",
    ...
    },
    {
        ...
        title: "Isolate Host",
        description:
            "Quarantine affected endpoint via EDR API, block at network level",
        icon: Cpu,
        color: "red",
...
const NODE_TEMPLATES: Omit<WorkflowNode, "id" | "position">[] = [
    {
        type: "action",
        title: "Enrichment",
        description: "Enrich indicator with external threat feeds",
        icon: Globe,
        color: "cyan",
    },
    {
        ...
        description: "Check if score exceeds configured threshold",
        icon: Shield,
        color: "amber",
    },
    {
        type: "action",
        title: "Notification",
        description: "Send alert to Slack/Teams/PagerDuty",
        icon: Mail,
        color: "green",
    },
    {
        type: "action",
        title: "Block Rule",
        description: "Push IOC to firewall/proxy blocklist",
        icon: Key,
        color: "red",
    },
];
...
function IOCDetailPanel({ selectedType }: { selectedType: string | null }) {
    ...
    const sampleIOCs: Record<
        string,
        { value: string; source: string; risk: string }[]
    > = {
        ip: [
        ...
        host: [{ value: "SE-KTH-RDP", source: "EDR", risk: "Compromised" }],
        adversary: [{ value: "TA542 (Emotet)", source: "MITRE", risk: "APT" }],
    };
        ...
        <div className="w-72 shrink-0 border-l border-border bg-surface overflow-y-auto">
            <div className="border-b border-border px-5 py-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <h2 className="font-display text-[13px] font-bold capitalize text-fg">
                            {selectedType}
                        </h2>
                    </div>
                </div>
            ...
            <div className="px-5 py-4 space-y-3">
                ...
                {iocs.map((ioc, i) => (
                    <div
                        key={i}
                        className="rounded-lg border border-border bg-bg px-3 py-2.5 space-y-1"
                    >
                        <p className="font-mono text-[11px] text-fg break-all">
                            {ioc.value}
                        </p>
...
export default function GraphAnalysisPage() {
    ...
    return (
        ...
        >
            {/* Canvas + Detail panel */}
            <div className="flex flex-1 overflow-hidden h-full py-1.5">
